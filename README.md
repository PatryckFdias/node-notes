# Node Notes - Aplicação Full Stack
...
3. Acesse a pasta `front-node-notess` e instale as dependências com `npm install`.
4. [Adicione aqui como inicia, ex: rode 'npm start' em ambos].